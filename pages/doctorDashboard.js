...
//                 type="button"
//                 class="cart-btn"
//                 onclick="event.stopPropagation(); addToCart('${escapeHTML(product.id)}')"
//             >
//                 🛒 Add To Cart
//             </button>
//         `
...
//             onkeydown="if(event.key === 'Enter'){ openProductDetails('${escapeHTML(product.id)}'); }"
//             data-id="${escapeHTML(product.id)}"
//             data-category="${escapeHTML(product.category)}"
//             data-company="${escapeHTML(product.company)}"
//             data-name="${escapeHTML(product.name)}"
...
//     const imageHTML = product.image
//         ? '<img src="' + escapeProductHTML(product.image) +
//           '" alt="' + escapeProductHTML(product.name) +
//           '" onerror="this.style.display=\'none\'; this.nextElementSibling.style.display=\'block\';">' +
//           '<div class="product-detail-placeholder" style="display:none;">💊</div>'
//         : '<div class="product-detail-placeholder">💊</div>';

//     const oldPriceHTML = mrp > price && mrp > 0
//         ? '<span class="detail-old-price">₹' + mrp.toFixed(0) + '</span>'
//         : '';

//     const packHTML = product.packSize
//         ? '<div>📦 <strong>Pack Size:</strong> ' +
//           escapeProductHTML(product.packSize) + '</div>'
//         : '';

//     const compositionHTML = product.composition
//         ? '<div>💊 <strong>Composition:</strong> ' +
//           escapeProductHTML(product.composition) + '</div>'
//         : '';

//     const companyHTML = product.company
//         ? '<div>🏭 <strong>Brand:</strong> ' +
//           escapeProductHTML(product.company) + '</div>'
//         : '';

//     const buttonHTML = inStock
//         ? '<button type="button" class="detail-cart-btn" ' +
//           'onclick="addToCart(\'' + escapeProductHTML(product.id) + '\')">' +
//           '🛒 Add To Cart</button>'
//         : '<button type="button" class="detail-cart-btn" disabled>' +
//           '🚫 Out of Stock</button>';
...
//                     escapeProductHTML(product.category || "Medicine") +
//                 '</span>' +
//                 '<h2 id="productDetailTitle">' +
//                     escapeProductHTML(product.name || "Product") +
//                 '</h2>' +
//                 '<p class="detail-description">' +
//                     escapeProductHTML(
//                         product.description || "Premium Healthcare Product"
//                     ) +
//                 '</p>' +
//                 '<div class="detail-info">' +
//                     packHTML + compositionHTML + companyHTML +
//                 '</div>' +
...
//                     '</span>' +
//                 '</div>' +
//                 '<div class="detail-stock ' + (inStock ? '' : 'out') + '">' +
//                     (inStock
//                         ? '● In Stock (' + stock + ')'
//                         : '● Out of Stock') +
//                 '</div>' +
...
//         event &&
//         event.target &&
//         event.target.id !== "productDetailModal"
//     ) {
//         return;
//     }
...
function productCard(product, type = "") {
    ...
    const buttonHTML = inStock
        ...
        ? `
            <button
                type="button"
                class="cart-btn"
                onclick="event.stopPropagation(); addToCart('${escapeHTML(productId)}')"
            >
                🛒 Add To Cart
            </button>
        `
    ...
    return `
        ...
        <article
            ...
            role="button"
            tabindex="0"
            onclick="openProductDetails('${escapeHTML(productId)}')"
            onkeydown="if(event.key === 'Enter'){ openProductDetails('${escapeHTML(productId)}'); }"
...
function openProductDetails(productId) {
    ...
    const detailAddButton = document.getElementById(
        "detailAddToCartBtn"
    );
...
async function addToCart(productId) {
    ...
    try {
        ...
        /* Some cart routes use PUT instead of POST. */
        if (
            response.status === 404 ||
            response.status === 405
        ) {
